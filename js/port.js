...
$(document).ready(function(){
    ...
    if(isMobile) {
        ...
        $(window).scroll(function() {
              scrollOp('#grades-proj .card-block')
          });
    ...
    $('#my-navbar-sm .nav-link').on('click', function() {
        $('#my-navbar-sm').toggleClass('in');
    }); //collapses dropdown nav when link is clicked
	...
	}); //causes page to scroll to section rather than automatically jump
